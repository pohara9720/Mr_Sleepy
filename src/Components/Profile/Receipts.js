...
class Receipts extends Component<Props> {
  ...
  render() {
    ...
    const Back = (props) => {
     ...
     console.log(typeof this.props.store.invoices)
    return (
      <View style={styles.container}>
        <Header
            leftComponent={<Back />}
            centerComponent={{ text: 'Invoices', style: { color: '#a020f0',fontSize:22}}}
        ...
        <ScrollView style={{flex:1,padding:15}}>
            {
              ...
              <View>
                  ...
                  this.props.store.invoices.lines && this.props.store.invoices.lines.data.map((l,i,a) => 
                      <View style={i === a.length -1 ? styles.last : styles.item}>
                            <Icon 
                                name='favorite'
                                color='#a020f0'
                                size={12}
